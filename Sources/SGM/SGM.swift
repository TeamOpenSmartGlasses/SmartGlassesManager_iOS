...
public class SGM: NSObject, CBCentralManagerDelegate {
    ...
    let ultraliteLeftSidePixelBuffer = 80
    ...
    private var titleYOffset = 120
    private var bodyYOffset = 240
    ...
    public func moveReferenceCardSimple(title: String, body: String, directionUp: Bool) {
        ...
        _ = device.canvas.createText(text: title, textAlignment: .auto, textColor: .white, anchor: .topLeft, xOffset: ultraliteLeftSidePixelBuffer, yOffset: titleYOffset, isVisible: true, width: 640 - ultraliteLeftSidePixelBuffer, height: -1, wrapMode: .wrap)
        _ = device.canvas.createText(text: body, textAlignment: .auto, textColor: .white, anchor: .topLeft, xOffset: ultraliteLeftSidePixelBuffer, yOffset: bodyYOffset, isVisible: true, width: 640 - ultraliteLeftSidePixelBuffer, height: -1, wrapMode: .wrap)
